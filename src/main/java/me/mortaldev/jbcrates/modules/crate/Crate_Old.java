...
public class Crate_Old {
  ...
  Integer amountToWin;
  CrateManager.SortBy sortBy;
  CrateManager.Order order;
  ...
  private Crate_Old(
      ...
      @JsonProperty("rewardsMap") Map<String, Double> rewardsMap,
      @JsonProperty("rewardsDisplayMap") LinkedHashMap<String, String> rewardsDisplayMap,
      @JsonProperty("amountToWin") Integer amountToWin,
      @JsonProperty("sortBy") CrateManager.SortBy sortBy,
      @JsonProperty("order") CrateManager.Order order) {
  ...
  public void setRewardsDisplayMap(LinkedHashMap<ItemStack, Component> rewardsDisplayMap) {
    ...
    rewardsDisplayMap.forEach(
        (key, value) ->
            this.rewardsDisplayMap.put(encodeItemStack(key), TextUtil.serializeComponent(value)));
  }
